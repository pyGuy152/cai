...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/jerry)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/jerry
```

A live public deployment of this template is available at [https://jerry.templates.workers.dev](https://jerry.templates.workers.dev)
